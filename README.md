...
- API Key
- Device ID
- شماره‌های گیرنده، گزینه ارسال فاکتور به خریدار و کد کشور
...
برای ارسال فاکتور به خریدار، در بخش **وضعیت‌ها و گیرنده‌ها** گزینه **ارسال فاکتور به خریدار** را فعال کنید. در این حالت شماره صورتحساب سفارش، در صورت وجود و معتبر بودن، علاوه بر شماره‌های ثابت به گیرنده‌ها اضافه می‌شود. خاموش‌کردن این گزینه فقط ارسال به خریدار را متوقف می‌کند و روی گیرنده‌های ثابت اثری ندارد.

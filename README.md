...
گزارش هفتگی از همان API و شماره‌های ادمین استفاده می‌کند. بازه گزارش، ۷ روز تقویمی کامل پیش از زمان اجرا است و با ۷ روز پیش از آن مقایسه می‌شود. روز ارسال قابل تنظیم است و مقدار پیش‌فرض شنبه است؛ در این حالت گزارش شنبه تا جمعهٔ قبل ساخته می‌شود.

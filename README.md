...
دکمه **ارسال گزارش ۲۴ ساعت گذشته همین حالا** بدون نیاز به فعال‌بودن زمان‌بندی، یک گزارش واقعی از بازه شناور ۲۴ ساعت گذشته می‌سازد و به گیرندگان گزارش می‌فرستد. درصد فروش این گزارش با بازه ۲۴ تا ۴۸ ساعت قبل مقایسه می‌شود؛ بنابراین هم برای تست اتصال و هم برای دریافت گزارش فوری قابل استفاده است.

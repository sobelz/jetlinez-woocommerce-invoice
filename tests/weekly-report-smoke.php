...
jlwi_weekly_assert( false !== strpos( $message, 'تعداد کل سفارش‌ها: 6' ), 'Weekly total order count is incorrect.' );
jlwi_weekly_assert( false !== strpos( $message, 'سفارش‌های پرداخت‌شده: 3' ), 'Weekly paid order count is incorrect.' );
...
jlwi_weekly_assert( false !== strpos( $orders_only, 'تعداد کل سفارش‌ها: 6' ), 'Enabled weekly section was omitted.' );
jlwi_weekly_assert( false !== strpos( $orders_only, 'سفارش‌های پرداخت‌شده: 3' ), 'Paid order count was omitted.' );
...
jlwi_weekly_assert( array( 'Previous week', 'Current week' ) === $quickchart_payload['chart']['data']['labels'], 'The chart does not compare the two weeks.' );
jlwi_weekly_assert( array( 100, 91.7 ) === $quickchart_payload['chart']['data']['datasets'][0]['data'], 'The weekly indexed comparison is incorrect.' );
jlwi_weekly_assert( false !== strpos( $quickchart_payload['chart']['options']['plugins']['subtitle']['text'], '-8.3%' ), 'The calculated weekly change is missing from the chart.' );
jlwi_weekly_assert( 120 === $quickchart_payload['chart']['data']['datasets'][0]['maxBarThickness'], 'The chart bars should have a readable maximum width.' );

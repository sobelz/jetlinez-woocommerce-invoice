					...
					<table class="form-table" role="presentation">
						...
						<tr>
							...
							<td>
								...
								<p class="description"><?php echo esc_html__( '«مشتری جدید» مشتری یکتایی است که پیش از شروع بازه سفارش پرداخت‌شده نداشته باشد. «رهاشده» شامل سفارش‌های ناموفق و سفارش‌های در انتظار پرداختِ قدیمی‌تر از مهلت نگهداری موجودی ووکامرس است (در صورت غیرفعال‌بودن آن مهلت، ۶۰ دقیقه). بخش موجودی فقط زمانی به پیام اضافه می‌شود که موردی وجود داشته باشد.', JLWI_TEXT_DOMAIN ); ?></p>
							</td>
						</tr>
						</tbody>
					</table>
					...
					<table class="form-table" role="presentation">
						...
						<tr>
							...
							<td>
								...
								<p class="description"><?php echo esc_html__( 'همه بخش‌ها به‌صورت پیش‌فرض فعال‌اند. با فعال‌بودن «رشد یا افت»، یک نمودار دوستونی JPG نیز از QuickChart دریافت و همراه متن ارسال می‌شود؛ فقط شاخص نسبی هفته‌ها، درصد تغییر و کد ارز به سرویس نمودار می‌رود و در صورت خطا، گزارش صرفاً متنی باقی می‌ماند. مشتری جدید یعنی مشتری‌ای که پیش از این بازه سفارش پرداخت‌شده نداشته است؛ محصولات کم‌فروش نیز فقط از میان محصولاتی انتخاب می‌شوند که در هفته فروش داشته‌اند.', JLWI_TEXT_DOMAIN ); ?></p>
							</td>
						</tr>
						</tbody>
					</table>

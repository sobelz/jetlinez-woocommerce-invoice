...
* تفکیک شماره‌های ثابت ادمین‌ها از شماره صورتحساب مشتری
...
* افزودن ماتریس نوع ارسال به تفکیک وضعیت سفارش و گیرنده (مشتری/ادمین).
* پشتیبانی از حالت‌های عدم ارسال، فقط متن، فقط فایل فاکتور و متن و فایل.
* جداسازی سابقه تحویل مشتری و ادمین حتی در صورت یکسان بودن شماره تلفن.
* حفظ خودکار تنظیمات عمومی PDF/متن نسخه‌های قبلی هنگام ارتقا.

...
با فعال‌بودن بخش رشد/افت، یک نمودار میله‌ای JPG نیز از QuickChart دریافت و از مسیر مدیای جتلاینز ارسال می‌شود. فقط درصد تغییر و کد ارز در درخواست نمودار قرار می‌گیرد و هیچ مبلغ فروش، اطلاعات فروشگاه، سفارش، محصول، مشتری، گیرنده یا کلید API به QuickChart فرستاده نمی‌شود. هر خطای دریافت، اعتبارسنجی، آپلود یا ارسال نمودار به ارسال صرفاً متنی برمی‌گردد.

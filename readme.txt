...
فروش خالص امروز و تغییر نسبت به بازه مشابه دیروز، تعداد سفارش‌ها، میانگین سفارش‌های پرداخت‌شده، مشتریان یکتای دارای اولین سفارش پرداخت‌شده، سفارش‌های لغو/بازپرداخت/رهاشده و محصولاتی که بر اثر فروش‌های همان بازه ناموجود شده‌اند. محصولات از قبل ناموجود یا فقط کم‌موجود در این بخش تکرار نمی‌شوند. هر بخش از پنل قابل غیرفعال‌کردن است و گزارش از همان دستگاه واتساپ و فهرست مستقل گیرندگان گزارش استفاده می‌کند. دکمه ارسال فوری همین شاخص‌ها را برای ۲۴ ساعت گذشته محاسبه و با ۲۴ ساعت قبل از آن مقایسه می‌کند.
